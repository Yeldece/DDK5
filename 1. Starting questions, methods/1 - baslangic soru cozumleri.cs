...
namespace Console_review
{
    public class QuestionAnswers
    {
        ...
        public static void Soru2()
        {
            ...
            if (sayi <= 0)
            {
                Console.WriteLine("Error, the number must be bigger than 0");
            }
            for (; sayi >= 0; sayi--)
            {
        ...
        //tahmin oyunu
        //guess number game
        public static void RandomGuessGame()
        {
        ...
        public static void TelefonNumarasi()
        {
