...
namespace Console_review
{
    public class MethodQuestions
    {
        ...
        public static int MethodSoru1(string text)
        {
            int length = 0;
        ...
        #endregion
        #region  methodSoru2
        public static string MethodSoru2(string text1, string text2)
        {
            text1 = text1.ToUpper();
            text2 = text2.ToUpper();
        ...
        //How many "A" in the given string parameter 
        public static int MethodSoru3(string text)
        {
            text = text.ToLower();
            int counter = 0;
        ...
        //Convert given string parameter to all lowerise except first character HELLO->Hello
        public static string MethodSoru4(string text)
        {
            text = text.Trim();
        ...
        public static string MethodSoru6(string text)
        {
            string text2 = "";
            if (text.Length > 2)
            {
        ...
        public static string[] MethodSoru10(string text)
        {
            string[] result;
            if (text.Length % 2 == 1)
            {
        ...
        public static decimal MethodSoru21(decimal degreeInCelcius)
        {
